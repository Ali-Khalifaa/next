...
//----------- import course excel --------------
Route::post('/courseImport','CourseController@courseImport');
...
//----------- get clients--------------
Route::get('/getClint','LeadController@getClint');
...
//----------- company activity  --------------
Route::post('/companyPayment/{id}','CompanyPaymentController@store');
Route::resource('companyPayment', 'CompanyPaymentController');

//----------- get company Details --------------
Route::get('/getCompanyDetails/{id}','CompanyPaymentController@getCompanyDetails');
...
Route::resource('companyDeal', 'CompanyDealController');

//----------- get public discount --------------
Route::get('companyDealByCompanyId/{id}','CompanyDealController@companyDealByCompanyId');
...
Route::post('/changingWaitingStatusCourse/{id}', 'CourseTrackController@changingWaitingStatus');
...
Route::post('/changingWaitingStatus/{id}', 'DiplomaTrackController@changingWaitingStatus');
...
// ============ Student Tree Management =======================================

Route::resource('studentTree', 'StudentTreeController');

//----------- get course track and diploma track by country id--------------
Route::get('getTrackByCountryId/{id}', 'StudentTreeController@getTrackByCountryId');

//----------- get lead by course or diploma id and type--------------
Route::get('getLeadInCountry/{id}/{type}', 'StudentTreeController@getLeadInCountry');

//----------- get comment student by lead id and course or diploma id and type --------------
Route::get('getCommentSTudent/{lead_id}/{id}/{type}', 'StudentTreeController@getCommentSTudent');
